...
const Index = () => {
  ...
  const tariffs = [
    ...
    },
    {
      ...
      minutes: '700 мин',
      sms: '700 SMS',
      features: ['Безлимит на мессенджеры', '5G', 'Перенос номера', 'Бесплатно по РФ'],
      popular: true,
    },
    {
      name: 'Макс',
            ...
            {tariffs.map((tariff, idx) => (
              ...
              >
                ...
                <CardHeader>
                  ...
                  <CardDescription>
                    <span className="text-4xl font-bold text-foreground">300₽</span>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-sm text-muted-foreground">Бесплатно по РФ</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="pt-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <div className="text-muted-foreground">g-telecom@my.com</div>
